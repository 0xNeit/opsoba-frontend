describe('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'SOBA')
  ...
  it('loads the BNB and tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokenb #pair').should('contain.text', 'SOBA')
  })
  ...
  it('does not crash if address is duplicated', () => {
    ...
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'SOBA')
    cy.get('#add-liquidity-input-tokenb #pair').should('not.contain.text', 'SOBA')
  })
