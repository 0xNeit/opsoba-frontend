  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active SobaSwap Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold SOBA'),
      bodyText: [t('Each NFT costs SOBA to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://sobaswap.finance/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82"
            target="_blank"
            width="100%"
          >
            {t('Buy SOBA')}
