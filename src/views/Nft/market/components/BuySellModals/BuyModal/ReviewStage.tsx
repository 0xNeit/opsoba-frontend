...
import { Flex, Text, Button, ButtonMenu, ButtonMenuItem, Message, Link } from 'opsoba-uikit'
      ...
      <Flex px="24px" pt="24px" flexDirection="column">
        ...
        <Flex alignItems="center">
          ...
          <Button
            ...
            external
            variant="text"
            href="/swap?inputCurrency=BNB&outputCurrency=0x4200000000000000000000000000000000000006"
          >
            {t('Convert')}
          </Button>
        </Flex>
