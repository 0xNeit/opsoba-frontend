...
export const swapSectionData: SalesSectionProps = {
  ...
  secondaryButton: {
    to: 'https://docs.sobaswap.finance/',
    text: 'Learn',
    external: true,
  },
  images: {
...
export const earnSectionData: SalesSectionProps = {
  ...
  bodyText: 'SobaSwap makes it easy to make your crypto work for you.',
  reverse: true,
  primaryButton: {
    to: '/farms',
    text: 'Explore',
  ...
  secondaryButton: {
    to: 'https://docs.sobaswap.finance/products/yield-farming',
    text: 'Learn',
    external: true,
  },
  images: {
