...
import { Flex, Button, Text, AutoRenewIcon, PresentWonIcon } from 'opsoba-uikit'
...
const ClaimInnerContainer: React.FC<ClaimInnerProps> = ({ onSuccess, roundsToClaim }) => {
  ...
  const sobaReward = activeClaimData.sobaTotal
  const dollarReward = sobaReward.times(sobaPriceBusd)
  const rewardAsBalance = getBalanceAmount(sobaReward).toNumber()
      ...
      if (receipt.status) {
        toastSuccess(
          ...
          <ToastDescriptionWithTx txHash={receipt.transactionHash}>
            {t('Your SOBA prizes for round %lotteryId% have been sent to your wallet', { lotteryId })}
