...
import { Button, Heading, Text, Flex, Link, Breadcrumbs } from 'opsoba-uikit'
...
const SOBA_BURN_BG_LIGHT = 'radial-gradient(50% 79.31% at 50% 50%, #FAF9FA 0%, #EAECF4 100%)'
const SOBA_BURN_TOP_FILL_LIGHT = 'radial-gradient(ellipse at bottom, #f0f1f6, #EAECF4)'
const SOBA_BURN_BG_DARK = 'radial-gradient(103.12% 50% at 50% 50%, #152534 0%, #191326 100%)'
const SOBA_BURN_TOP_FILL_DARK = '#191326'
  ...
  return (
    <>
        ...
        <Flex flexDirection={['column-reverse', null, 'row']}>
          <Left>
            ...
            <Text color="textSubtle" mb="24px">
              {t('Each week, qualifying projects can bid SOBA for the right to host a 7-day Farm on PancakeSwap.')}
            </Text>
      ...
      <>
        ...
        <PageSection
          background={theme.isDark ? SOBA_BURN_BG_DARK : SOBA_BURN_BG_LIGHT}
          index={2}
        ...
        <PageSection
          ...
          dividerFill={{ light: SOBA_BURN_BG_LIGHT, dark: SOBA_BURN_BG_DARK }}
          concaveDivider
          index={3}
          dividerPosition="top"
        >
