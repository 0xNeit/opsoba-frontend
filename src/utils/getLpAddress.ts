...
const getLpAddress = (token1: string | Token, token2: string | Token) => {
  ...
  if (typeof token1 === 'string' || token1 instanceof String) {
    ...
    token1AsTokenInstance = new Token(ChainId.MAINNET, checksummedToken1Address, 18, 'Soba-LP')
  }
  if (typeof token2 === 'string' || token2 instanceof String) {
    ...
    token2AsTokenInstance = new Token(ChainId.MAINNET, checksummedToken2Address, 18, 'Soba-LP')
  }
