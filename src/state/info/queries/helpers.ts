...
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, SobaDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | SobaDayData): ChartEntry => ({
