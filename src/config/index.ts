...
export const BASE_BSC_SCAN_URLS = {
  [ChainId.MAINNET]: 'https://mainnet.opbnbscan.com',
  [ChainId.TESTNET]: 'https://opbnbscan.com',
}
...
export const BASE_URL = 'https://sobaswap.finance'
...
export const SOBA_BUNNIES_UPDATE_FREQUENCY = 8000
