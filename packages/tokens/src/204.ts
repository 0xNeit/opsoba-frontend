...
import { BUSD_MAINNET, SOBA_MAINNET, USDT_MAINNET } from './common'
...
export const bscTokens = {
  ...
  gal: new Token(ChainId.MAINNET, '0xe4Cc45Bb5DBDA06dB6183E8bf016569f40497Aa5', 18, 'GAL', 'Galxe', 'https://galaxy.eco/'),
  ...
  co: new Token(ChainId.MAINNET, '0x936B6659Ad0C1b244Ba8Efe639092acae30dc8d6', 6, 'CO', 'CO', 'https://corite.com/'),
  krs: new Token(
    ChainId.MAINNET,
